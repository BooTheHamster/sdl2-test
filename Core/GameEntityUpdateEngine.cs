...
public sealed class GameEntityUpdateEngine
{
    ...
    {
        var lastUpdateTime = SDL.SDL_GetPerformanceCounter();
    ...
    private class GameEntityState(IGameEntity entity, ulong lastUpdateCount)
    {
        public readonly IGameEntity Entity = entity;
        public ulong LastUpdateCount = lastUpdateCount;
    }
}